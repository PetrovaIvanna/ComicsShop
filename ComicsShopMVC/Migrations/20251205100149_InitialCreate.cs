        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_ComicBooks_ComicBookId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "USA", 1939, "Marvel Comics" },
                    { 2, "USA", 1935, "DC Comics" },
                    { 3, "USA", 1986, "Dark Horse Comics" }
                });

            migrationBuilder.InsertData(
                table: "ComicBooks",
                columns: new[] { "Id", "Condition", "Discount", "IsRare", "IssueNumber", "Price", "PublicationDate", "PublisherId", "QuantityInStock", "Title" },
                values: new object[,]
                {
                    { 1, 1, 0, true, 492, 15.00m, new DateTime(1993, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 10, "Batman" },
                    { 2, 1, 0, false, 24, 25.00m, new DateTime(2018, 9, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 3, "Transformers: Lost Light" },
                    { 3, 0, 0, false, 19, 19.00m, new DateTime(2025, 5, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 100, "The Amazing Spider-Man" },
                    { 4, 0, 0, false, 20, 18.99m, new DateTime(2025, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 100, "The Amazing Spider-Man" },
                    { 5, 1, 0, false, 20, 12.99m, new DateTime(2025, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "The Amazing Spider-Man" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_ComicBookId",
                table: "OrderDetails",
                column: "ComicBookId");
